...
# script is part of overpass slackbuild; it assumes binaries installation into
# /usr/local/bin directory and the creation of overpass user and group as
# indicated in the main README file included with the slackbuild script
# This script should be run by the "overpass" user only.
#
# To use this script you need to set one varaible below:
# DB_DIR : set it to your actual installation database directory.
#
